    ...
    {
        public partial class MenuTitleDisplayRuntime : TownRaiserImGui.GumRuntimes.NineSliceRuntime
        {
            #region State Enums
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        TextInstanceWidthFirstValue = 99.66668f;
                        if (interpolationValue < 1)
                        {
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        TextInstanceWidthSecondValue = 99.66668f;
                        if (interpolationValue >= 1)
                        {
                            this.TextInstance.WidthUnits = Gum.DataTypes.DimensionUnitType.Percentage;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (TownRaiserImGui.GumRuntimes.MenuTitleDisplayRuntime.VariableState fromState,TownRaiserImGui.GumRuntimes.MenuTitleDisplayRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "TextInstance.Width",
                            Type = "float",
                            Value = TextInstance.Width + 99.66668f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
            ...
            public MenuTitleDisplayRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "MenuTitleDisplay");
