    ...
    {
        public partial class FontTestRuntime : TownRaiserImGui.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            SetProperty("TextInstance.CustomFontFile", "FontCache\\font-2.fnt");
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (TownRaiserImGui.GumRuntimes.FontTestRuntime.VariableState fromState,TownRaiserImGui.GumRuntimes.FontTestRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FontTestRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "FontTest");
