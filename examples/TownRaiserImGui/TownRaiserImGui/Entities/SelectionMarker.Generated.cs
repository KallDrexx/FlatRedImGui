...
{
    public partial class SelectionMarker : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable
    {
        ...
        public SelectionMarker (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public SelectionMarker (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void PostInitialize () 
        {
            ...
            SpriteInstance.LeftTexturePixel = 416f;
            SpriteInstance.RightTexturePixel = 432f;
            SpriteInstance.TopTexturePixel = 60f;
            SpriteInstance.BottomTexturePixel = 63f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SelectionMarkerStaticUnload", UnloadStaticContent);
